...
const serviceRoutes = [
  { path: "/api/auth", target: env.USER_SERVICE_URL, protected: false },
  { path: "/api/users", target: env.USER_SERVICE_URL, protected: true },
  { path: "/api/projects", target: env.PROJECT_SERVICE_URL, protected: true },
  {
    path: "/api/containers",
